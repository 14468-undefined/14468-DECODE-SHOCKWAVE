...
@Autonomous(name="A_REDNEARGATEDUMP")
public class A_REDNEARGATEDUMP extends SampleAuto {
    private BaseRobot robot;
    private ShootCommand shoot3;

    private int shooterRPMClose = 2135;//2135 //2100
    ...
    public void onStart() {
        ...
        while (opModeIsActive()) {
            ...
            Actions.runBlocking(robot.drive.actionBuilder(robot.drive.getPose())
                    ...
                    .strafeToConstantHeading(new Vector2d(-7.3, 48))
                    .strafeToConstantHeading(new Vector2d(-7.3, 64.5), new TranslationalVelConstraint(25))
