...
@Autonomous(name="A_BlueNear9FIELD1")
public class FIELD1BlueNear9 extends SampleAuto {
    ...
    public void onStart() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            Actions.runBlocking(robot.drive.actionBuilder(robot.drive.getPose())
                    ...
                    //MOTIF 2
                    .strafeToSplineHeading(new Vector2d(20, -9), Math.toRadians(270), new TranslationalVelConstraint(100))//go to motif
                    .strafeToConstantHeading(new Vector2d(22, -65))//intake

                    // ==============return============== \\
                    .strafeToConstantHeading(new Vector2d(24, -32))//back up
